$(function(){
  ...
  function game_start(){
    game_interval = setInterval(function(container, container_bottom, container_left, container_right, background_right, player_right, player_left, player_top, player_bottom, background_left, player_floor){
      container = $("#game_area");
      ...
      player_floor = container_bottom - (player.height()*1.5);
      move_player(player_bottom, container_bottom, background_right, player_right, player_left, container_left, player_floor);
      console.log("player bottom = "+ player_bottom);
  ...
  function move_player(player_bottom, container_bottom, background_right, player_right, player_left, container_left, player_floor){
    player.css({
    ...
    if (player_bottom >= player_floor) {
      // console.log(true);
      player_pos.y = player_floor - player.height();
      gravityspeed = 0;
      };
    if (player_bottom >= player_floor && jump == true) {
        player_pos.y -= 10;
